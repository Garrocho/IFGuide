...
public class Adaptador extends ArrayAdapter<String> {
    ...
    public Adaptador(Activity context, ArrayList<String> titulos, ArrayList<String> descricoes, ArrayList<String> datas, ArrayList<String> horas) {
    ...
    public View getView(int position,View view,ViewGroup parent) {
        ...
        View itemLista = inflater.inflate(R.layout.item_lista, null,true);
